...
public class Calculator {
    ...
    public String sumTwoNumber(int num1 ,int num2) {
        sumTwoNumber(10, 20);
        int sum =num1 + num2;
        //System.out.println("10과 20의 합은" +  sum + " 입니다.");
    ...
    public String multiTwoNumber(int first, int second){
        ...
        //System.out.println("10과 20의 곱은" + 200 + "입니다.");
        return "10과 20의 곱은" + sum + "입니다." ;
    }
    ...
    public int multiTwoNumber2(int first, int second){
        multiTwoNumber2(10 , 20);
        int sum = first * second;
        System.out.println("10과 20의 곱은" + sum + "입니다.");
        return sum;
